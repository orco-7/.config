...
myEditor :: String
myEditor =  "vim" --"emacsclient -c -a emacs "  -- Sets emacs as editor
...
myAppGrid = [ ("Brave", "brave")
                 ...
                 , ("freecad", "freecad")
		 , ("Steam", "steam")
		 , ("Videolezioni", "librewolf https://didattica.polito.it")
                 --, ("Geary", "geary")
                 --, ("Gimp", "gimp")
                 --, ("Kdenlive", "kdenlive")
...
--    xmproc1 <- spawnPipe "xmobar -x 1 $HOME/.config/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 1 $HOME/.config/xmobar/xmobarrc2"
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
                        { ppOutput = \x -> hPutStrLn xmproc0 x  >> hPutStrLn xmproc2 x
