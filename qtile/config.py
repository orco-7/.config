...
colors = [
        ...
        '973c54',   #background color
        '540d6e',   #inactove workspaces
        'ceccd1',   #active workspaces
        '84ccec',   #activer font
        'ceccd1',   #even widgets font
        '84ccec',   #odd widgets font
         ]

colors2 = [
        '6e44a0',   #background colors
        'f47d73',   #active font
        'dc457d',   #inactive font
        ]
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.Prompt(background = colors2[0]),
                widget.WindowName(
                                background = colors2[0],
                                foreground = colors2[1],
                                 ),
